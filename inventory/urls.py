...
urlpatterns = [
    ...
    url(r'^$',views.view_home,name='home_view'),
    url(r'^home/$',views.view_home,name='home_view'),
    url(r'^home/item/(?P<id>[-\w]+)/$',views.item_details,name='item_details'),
    ...
    url(r'^home/getchangedetails/$',views.getchangedetails,name='getchangedetails'),
